...
pretrained_model = "G:/Face age estimation/imdb_data/face_estimate/source_file/Finetune_with_appa/20_model_sum.hdf5"
...
def get_args():
    ...
    parser.add_argument("--image_dir", type=str, default="G:/Face age estimation/imdb_data/face_estimate/test",
                        help="target image directory; if set, images in image_dir are used instead of webcam")
